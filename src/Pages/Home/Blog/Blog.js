    ...
    return (
        <div className="min-h-[71vh] md:w-2/3 flex flex-col mx-auto justify-center ">
            <div className="border border-teal-600 p-3 rounded-lg">
                <Fragment>
                    <Accordion className="text-red-500" open={open === 1} icon={<Icon id={1} open={open} />}>
                        <AccordionHeader className="dark:hover:text-gray-200 dark:text-gray-500" onClick={() => handleOpen(1)}>
                            What are the different ways to manage a state in a React application?
                        </AccordionHeader>
                        <AccordionBody>
                            <span className="text-base text-gray-900 dark:text-gray-200 font-semibold">There are four main types of state manage in React apps</span>
                            <br />
                            <span className="text-base text-gray-900 dark:text-gray-200">They are: 1. Local state, 2. Global state, 3. Server state, 4. URL state</span>
                            <br />
                            <span className="text-base text-gray-900 dark:text-gray-200">Local state : Local state is data we manage in one or another component.</span>
                            <br />
                            <span className="text-base text-gray-900 dark:text-gray-200">Global state : Global state is data we manage across multiple components.</span>
                            <br />
                            <span className="text-base text-gray-900 dark:text-gray-200">Server state : Data that comes from an external server that must be integrated with our UI state.</span>
                            <br />
                            <span className="text-base text-gray-900 dark:text-gray-200">URL state : Data that exists on our URLs, including the pathname and query parameters.</span>
                        </AccordionBody>
                    </Accordion>
                    <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
                        <AccordionHeader className="dark:hover:text-gray-200 dark:text-gray-500" onClick={() => handleOpen(2)}>
                    ...
                    <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
                        <AccordionHeader className="dark:hover:text-gray-200 dark:text-gray-500" onClick={() => handleOpen(3)}>
                            What is a unit test? Why should we write unit tests?
                        </AccordionHeader>
                        <AccordionBody>
                            <span className="text-base text-gray-900 dark:text-gray-200">Unit testing is a type of software testing where individual units or software components are tested. Its purpose is to validate that each unit of code performs as expected. A unit can be anything you want it to be a line of code, a method, or a class. </span> <br />
                            <span className="text-base text-gray-900 dark:text-gray-200">They enable you to catch bugs early in the development process. Automated unit tests help a great deal with regression testing. They detect code smells in your codebase. For example, if you're having a hard time writing unit tests for a piece of code, it might be a sign that your function is too complex</span>
                        </AccordionBody>
                    </Accordion>
                    <Accordion open={open === 4} icon={<Icon id={4} open={open} />}>
                        <AccordionHeader className="dark:hover:text-gray-200 dark:text-gray-500" onClick={() => handleOpen(4)}>
