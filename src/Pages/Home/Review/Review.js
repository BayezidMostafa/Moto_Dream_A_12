    ...
    return (
        <div className='mb-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                <div className="container flex flex-col w-full shadow-sm hover:shadow-lg hover:shadow-teal-800 duration-300 shadow-teal-500 max-w-lg p-6 mx-auto divide-y rounded-md bg-white">
