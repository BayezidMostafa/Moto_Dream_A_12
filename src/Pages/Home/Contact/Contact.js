...
export const Contact = () => {
    ...
    return (
        <div id='contact' className='my-20 container mx-auto'>
            <div>
                <p style={{ textShadow: "0 0 3px teal" }} className='text-4xl text-center font-bold mb-10'>Contact</p>
            </div>
            <div className='grid md:grid-cols-2 grid-cols-1 md:gap-16'>
                ...
                <div className='mt-5 md:mt-0'>
                    <p style={{ textShadow: "0 0 3px teal" }} className='mb-3 text-2xl md:text-3xl lg:text-4xl font-bold'>Have some queries or suggestions?</p>
                    <div className='flex gap-2'>
                        <p className='text-justify text-[1.1rem]'>Any questions are welcome! Also, don't forget to let us know if you have any recommendations for our business. We'll do everything we can to improve our services as well.</p>
                    </div>
                </div>
            </div>
        </div>
